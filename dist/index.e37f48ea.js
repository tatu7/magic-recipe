...
var _reciepViewJs = require("./views/reciepView.js");
var _reciepViewJsDefault = parcelHelpers.interopDefault(_reciepViewJs);
...
const showRepset = async function() {
    try {
        ...
        if (!id) return;
        _reciepViewJsDefault.default.loadingSppiner();
        await _modelJs.loadReciep(id);
        data = _modelJs.state.recipe;
        _reciepViewJsDefault.default.render(data);
    } catch (err) {
        _reciepViewJsDefault.default.renderError();
        throw err;
    }
};
const searchController = async function() {
    ...
    const data = _modelJs.paginationLogic(6);
...
const paginationController = async function() {
    try {
        ...
        _paginationViewJsDefault.default.render(_modelJs.paginationLogic.state.search);
        _resultsViewJsDefault.default.render(data);
    } catch (err) {
        throw err;
    }
...
_reciepViewJsDefault.default.addHundler(showRepset);
_paginationViewJsDefault.default.addHundlerEvent(paginationController);

},{"./model.js":"Y4A21","./views/reciepView.js":"c2yIL","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/paginationView.js":"6z7bi"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "loadReciep", ()=>loadReciep
);
...
const state = {
    ...
    search: {
        ...
        results: {},
        page: 1,
        perPage: _config.RES_PER_PAGE
    }
};
const loadReciep = async function(id) {
    try {
        const data = await _helpers.getJson(_config.API + id);
...
const searchResults = async function(searchKey) {
    try {
        const data = await _helpers.getJson(_config.API + `?search=${searchKey}`);
...
},{"lodash":"3qBDj","regenerator-runtime":"dXNgZ","./config":"k5Hzs","./helpers":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports) {
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c2yIL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ReciepView {
    #errorMessage = 'Siz qidirayotgan Message Topilmadi';
  ...
  <div class="recipe__directions">
    ...
    <p>No recipes found for your query.${this.#errorMessage}</p>
  </div> `;
        this.#clearHtml();
        this.#parentElement.insertAdjacentHTML('afterbegin', html);
    }
...
class PaginationView {
    ...
    <button class="btn--inline pagination__btn--next">
        ...
        if (endPAGE > CurrentPAGE) this.#parentElement.insertAdjacentHTML('afterbegin', nextBtn);
        console.log('ccc');
    }
}
exports.default = new PaginationView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../img/icons.svg":"cMpiy"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire530f")
